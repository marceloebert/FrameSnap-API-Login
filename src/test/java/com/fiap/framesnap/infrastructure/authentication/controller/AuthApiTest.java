...
class AuthApiTest {
    ...
    @Test
    void shouldHandleNullRequestForRegistration() {
        // Act & Assert
        assertThrows(NullPointerException.class, () -> {
            authApi.registerUser(null);
        });
    }

    @Test
    void shouldHandleNullRequestForLogin() {
        // Act & Assert
        assertThrows(NullPointerException.class, () -> {
            authApi.login(null);
        });
    ...
    @Test
    void shouldHandleEmptyEmailForRegistration() {
        // Arrange
        UserRequest userRequest = new UserRequest("", "password123");
    ...
    @Test
    void shouldHandleEmptyPasswordForRegistration() {
        // Arrange
    ...
    @Test
    void shouldHandleEmptyEmailForLogin() {
        // Arrange
    ...
    @Test
    void shouldHandleEmptyPasswordForLogin() {
        // Arrange
